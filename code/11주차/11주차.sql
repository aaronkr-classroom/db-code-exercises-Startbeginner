...
(1, '김민준', 'A', 15, '2024-03-01'),
(2, '이서연', 'B', 22, '2024-03-15'),
(3, '박지훈', 'C', 8, '2024-04-05'),
(4, '최유진', 'D', 34, '2024-06-11'),
(5, '정도윤', 'E', 17, '2024-11-11');
...
-- 4. 'B' 유저가 현재 연결 중이다.
UPDATE users SET status = 'connecting' WHERE nickname = 'B';
